...
import P2413 from '../public/images/project-images/024/13.jpg';
...
export const portfolioData = [
  ...
  // BREAK
  {
    ...
    videoUrl: '',
    heroText:
      'Armstrong Build demolished original Westfield house, to make way for the new build, consisting of 6 bedrooms, 9 bathrooms. This sustainable property includes ground source heat pumps, solar panels and underfloor heating.',
    mainText: [
      'Armstrong Build embarked on a bold and transformative property development project with the demolition of the original Westfield house, paving the way for a new build that redefines luxury living. The result is a residence boasting six bedrooms and an impressive nine bathrooms, setting a new standard for opulence and functionality.',
...

  {
    ...
    videoUrl: '',
    heroText:
      'Built in the 19th century this Grade II- listed building situated in The Solent sea between the port of Portsmouth and The Isle of Wight was originally built as part of the British sea defences, has now recently been turned into a 22 bedroom hotel, with helipad, hot tubs, spa and its own putting green. Armstrong Build worked with the main developers on the structural steel works within the actual Fort, structural openings within 8 foot thick walls, with the incorporating of fire escapes and with stabilisation of the building, all within a short timeframe',
    mainText: [
      'The intricacy of this project was amplified by the historical significance of the building and its unique location. Armstrong Build, collaborating closely with the main developers, undertook extensive structural steel works within the fort. This involved careful planning and execution to ensure that the modern additions seamlessly integrated with the original architecture while meeting contemporary safety and engineering standards.',
      "Incorporating essential fire escapes into a structure with such historical significance demanded a delicate balance between safety regulations and preservation. Armstrong Build's approach showcased their ability to blend modern safety requirements seamlessly into the historical fabric of the building, ensuring that the safety features did not compromise the architectural and historical essence of the fort.",
      "Armstrong Build's involvement in the renovation of this Grade II-listed fort in The Solent sea exemplifies their ability to undertake complex projects that demand a delicate balance between historical preservation and modern functionality. The successful transformation of this historic landmark into a 22-bedroom hotel with upscale amenities attests to Armstrong Build's prowess in architectural innovation and structural engineering within the context of historical restoration.      ",
    ],
  },
  // BREAK
  {
    ...
    videoUrl: '',
    heroText:
      'Once Harborns indoor market, Armstrong Build converted this property into the  ice cream pallor, Pardice Gelateria. This was all achieved under a limited completion schedule. Armstrong Build was able to work alongside an Italian company to fit innovative commercial catering equipment and specialist working kitchens.',
    mainText: [
      "The property's transition from an indoor market to a gelateria required a keen understanding of the specific needs of a commercial food establishment. Armstrong Build embraced the challenge by space by enhancing it to suit the demands of a modern business.",
    ],
  },
  // BREAK
  {
    ...
    videoUrl: '',
    heroText:
      'The Ash Tree Pharmacy underwent a comprehensive renovation, both internally and externally, as part of a commercial building project. Our team meticulously transformed the interior and exterior spaces, implementing modern design elements and functional improvements. ',
    mainText: [
      'The renovation aimed to create a welcoming and efficient environment, aligning with the standards of contemporary commercial spaces while enhancing the overall aesthetic appeal of Ash Tree Pharmacy',
    ],
  },
  // BREAK
  {
    ...
    videoUrl: '',
    heroText:
      'A Grade III Listed building in the heart of a busy high st in Strafford. Armstrong Build has caringly renovated and refurb a small hotel consisting of  5 existing bedroom, adding en-suites to each room, all whilst still remaining open to the public.',
    mainText: [
      "In the heart of a bustling high street in Strafford, Armstrong Build undertook the meticulous renovation and refurbishment of a Grade III Listed building housing a small hotel. With a commitment to preserving the historical charm, our team added a touch of modern luxury by carefully incorporating en-suites into each of the existing 5 bedrooms. Remarkably, the project was carried out with the hotel remaining open to the public throughout the transformation, showcasing Armstrong Build's dedication to both historical preservation and uninterrupted service delivery.",
    ],
  },
  // BREAK
  {
  ...
  // BREAK
  {
    ...
    videoUrl: '',
    heroText:
      "On the rooftop of a residential property, a sleek and modern solar panel installation has been seamlessly integrated. The photovoltaic panels harness sunlight to generate clean and renewable energy, significantly reducing the household's reliance on traditional power sources. This sustainable addition not only contributes to lowering energy bills but also aligns with the homeowner's commitment to eco-friendly living.",
    mainText: [],
  },
  // BREAK
  {
    ...
    videoUrl: '',
    heroText:
      "At a suburban residence, a rainwater harvesting system has been discreetly installed to capture and store rainwater. The system includes a network of gutters and downspouts directing rainwater into storage tanks. This harvested rainwater is then utilised for irrigation, reducing reliance on municipal water supplies and promoting water conservation. The implementation of rainwater harvesting aligns with the homeowner's commitment to sustainable and responsible water management.",
    mainText: [],
  },
  // BREAK
  {
    ...
    videoUrl: '',
    heroText:
      "In a newly constructed eco-conscious office building, a solar heating system has been strategically incorporated. The building's architecture allows for optimal exposure to sunlight, and solar collectors efficiently harness solar energy to provide warmth for the interior spaces. This innovative heating solution not only ensures a comfortable working environment but also reflects the company's dedication to sustainable and cost-effective energy practices.",
    mainText: [],
  },
  // BREAK
  {
    ...
    videoUrl: '',
    heroText:
      'At this residential property, a cutting-edge sustainable plant room has been installed to enhance energy efficiency and reduce environmental impact. This dedicated space incorporates advanced equipment for heating, cooling, and ventilation, specifically designed to adhere to stringent sustainability standards. The seamless integration of state-of-the-art technologies ensures that the home operates with a minimal carbon footprint, underscoring a strong commitment to eco-friendly construction practices and responsible energy use.',
    mainText: [],
  },
  // BREAK
  {
    ...
    videoUrl: '',
    heroText:
      "Armstrong Build took on a multifaceted project at the Birmingham Women & Children's Hospital, including interior renovations and improvements to the car park and landscaping. ",
    mainText: [
      "Our team worked diligently to enhance the hospital's interior spaces, ensuring a welcoming and functional environment for patients and staff. Simultaneously, we executed strategic upgrades to the car park and landscaping, contributing to a holistic transformation that prioritises accessibility, aesthetics, and the overall well-being of those utilizing the facility.",
      "Armstrong Build has an ongoing renovation project at Birmingham Women & Children's Hospital, focusing on both interior enhancements and the transformation of the car park and landscaping. Within the hospital, our team worked to create modern and efficient spaces, fostering a positive atmosphere for patients and medical professionals. Simultaneously, we revitalised the exterior to provide an optimal environment for all.",
    ],
  },
  // BREAK
  {
    ...
    videoUrl: '',
    heroText:
      "At Queen Elizabeth Hospital, Armstrong Build spearheaded a comprehensive project that involved interior renovations along with substantial improvements to the hospital's car park and landscaping. ",
    mainText: [
      'Within the hospital premises, our team focused on enhancing interior spaces to provide a modern and conducive environment for patients and healthcare professionals. Concurrently, we undertook strategic upgrades to the car park and landscaping, aiming to create a harmonious and welcoming exterior.',
      ' This project was a perfect demonstration of our ability to elevate healthcare facilities by balancing functionality and aesthetics for the benefit of all who interact with the hospital.',
    ],
  },
  // BREAK
  {
    ...
    videoUrl: '',
    heroText:
      'This project involved comprehensive landscaping and improvement works for the car park at Kidderminster Hospital. Our team executed a range of enhancements, including green spaces, designated parking areas, and improved traffic flow. The revitalized car park not only enhances the overall aesthetics of the hospital premises but also prioritizes functionality and ease of access for patients, visitors, and staff.',
    mainText: [
      'The improvements encompassed features such as well-defined parking spaces, green landscaping elements, and enhancements to improve the overall accessibility and flow of the car park. The space now offers both functionality and visual appeal, contributing to a positive experience for hospital visitors and staff.',
    ],
  },
  // BREAK
  {
    ...
    videoUrl: '',
    heroText:
      'The Oaklands Centre, dedicated to healthcare, underwent a transformative project encompassing renovations and external enhancements. Our team diligently installed new windows, along with strategically placed roller shutters, as part of a comprehensive overhaul. Additional works were undertaken to elevate both the functionality and aesthetic appeal of this healthcare facility, ensuring it meets contemporary standards while providing a conducive environment for its vital services.',
    mainText: [
      'These renovations and external upgrades at the Oaklands Centre reflect our commitment to creating an environment that aligns with modern healthcare standards. The introduction of new windows enhances natural light, fostering a bright and welcoming atmosphere within the facility. The installation of roller shutters not only contributes to security but also offers a practical solution for light control and privacy.',
    ],
  },
  // BREAK
  {
    ...
    videoUrl: '',
    heroText:
      'Mr Pitan new build commercial property consisting of a pharmacy with a two storey flat above',
    mainText: [
      'Armstrong Build completes the construction of a new commercial property, featuring a ground-floor pharmacy and a two-story flat above. This innovative project aims to combine a thriving business space with comfortable residential living, providing a convenient and integrated solution for both commercial and residential needs.',
    ],
  },
  // BREAK
  {
    ...
    videoUrl: '',
    heroText:
      'In this project, our team embarked on a comprehensive renovation and extension of an 1880-built property. Beginning with stripping the property back to its bare brick, we initiated a full-scale transformation, combining historical preservation with modern design to breathe new life into this charming and age-old structure.',
    mainText: [
      'In this undertaking, we undertook an extensive renovation and extension of a property dating back to 1880. Our approach commenced by reverting the property to its bare brick state, setting the stage for a thorough revitalization. Through a harmonious blend of historical preservation and contemporary design, our team executed a holistic transformation, injecting vitality into this captivating structure.',
    ],
  },
  // BREAK
  {
    ...
    videoUrl: '',
    heroText:
      'The owner acquired a plot of land with a vision to construct a luxurious residence. The project entails the construction of a magnificent 7-bedroom, 9-bathroom property that includes the unique feature of an internal pool. This ambitious undertaking reflects a commitment to creating a spacious and opulent home that harmonizes modern comfort with distinctive amenities.',
    mainText: [
      "The task at hand involves the development of a prestigious property on a newly acquired plot. The owner's vision is set on crafting a lavish 7-bedroom, 9-bathroom residence, complete with the opulence of an internal pool. This project epitomizes a fusion of grandeur and functionality, demonstrating an unwavering commitment to bespoke living spaces and luxury amenities.",
    ],
  },
  // BREAK
  {
    ...
    videoUrl: '',
    heroText:
      'Mark and Phil, the proud owners of the property, embarked on an ambitious project with Armstrong Build that encompassed extension, renovation, and landscaping. This comprehensive endeavor aimed to not only expand the living space but also revitalize the existing structure both inside and out.',
    mainText: [
      "The extension involved careful planning and execution to seamlessly integrate new spaces that cater to the specific needs and desires of Mark and Phil. Whether it be an expanded living area, additional bedrooms, or enhanced utility spaces, the extension was designed to enhance the functionality of the home while adhering to the owners' vision.",
      'Simultaneously, the renovation process took the existing structure back to its core, allowing for a meticulous transformation. Mark and Phil, in collaboration with Armstrong Build, worked on upgrading and modernizing the interior spaces. This might include new flooring, updated fixtures, and a thoughtful redesign to align with contemporary aesthetics.',
      'The landscaping aspect of the project was a key element, aiming to create outdoor spaces that complemented the overall vision of the property. Whether it involved garden enhancements, the addition of outdoor living areas, or the installation of features that enhance curb appeal, the landscaping component added the finishing touches to the project.',
    ],
  },
  // BREAK
];
